module.exports = function (__secret = '', __user = '') {
    ...
    module.checkBalanceCenterLTCInternet= function () {
        var deferred = Q.defer();
        var soap = require('soap');
        var url = 'http://ltcservice.laotel.com:6848/Services.asmx?WSDL';
        this.ltcEncrypt(ltcUser).then(function (body) {
    ...
    module.checkBalanceCenterLTCPSTN= function () {
        var deferred = Q.defer();
        var soap = require('soap');
        var url = 'http://ltcservice.laotel.com:6848/Services.asmx?WSDL';
        this.ltcEncrypt(ltcUser).then(function (body) {
    ...
    module.topupLTCPOSTPAID= function (phone, value) {
        var deferred = Q.defer();
        m = validatePhone(phone);
        m1 = validateValue(value);
        if (m != "OK" || m1 != "OK")
    ...
    module.paymentLTCPOSTPAID= function (phone, value) {
        var deferred = Q.defer();
        m = validatePhone(phone);
        m1 = validateValue(value);
        if (m != "OK" || m1 != "OK")
    ...
    module.checkBalanceCenterLTCPOSTPAID= function () {
        var deferred = Q.defer();
        var soap = require('soap');
        var url = 'http://ltcservice.laotel.com:6848/Services.asmx?WSDL';
        this.ltcEncrypt(ltcUser).then(function (body) {
    ...
    module.checkBalanceLTCPOSTPAID= function (phone) {
        var deferred = Q.defer();
        m = validatePhone(phone);
        if (m != "OK")
            throw new Error(m);
